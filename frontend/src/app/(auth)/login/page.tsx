      ...
      <div className="bg-manifest-paper border border-steel-blue/30 shadow-[0_10px_30px_rgba(0,0,0,0.5)] rounded-sm overflow-hidden">
        ...
        <div className="px-8 pb-8 pt-4 space-y-3">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-medium py-3 px-4 hover:bg-gray-50 hover:shadow-sm transition-all"
          >
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#24292f] text-white font-medium py-3 px-4 hover:bg-[#1b1f23] transition-all"
          >
